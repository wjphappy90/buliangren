...
<head>
    ...
    <title>系统主页</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/back/boot/css/bootstrap.min.css">
    <script src="${pageContext.request.contextPath}/back/boot/js/jquery-3.4.1.min.js"></script>
    <script src="${pageContext.request.contextPath}/back/boot/js/bootstrap.min.js"></script>
    <script>
        $(function(){
           /* $("#btn").click(function(){
            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                        <div class="panel-body">
                            <div class="list-group">
                                <a href="javascript:$('#content').load('${pageContext.request.contextPath}/back/users/list_cpoy.jsp?name=userList');" id="btn" class="list-group-item active">
                                    用户列表
                                </a>
                                <a href="javascript:$('#content').load('${pageContext.request.contextPath}/back/users/list_cpoy.jsp?name=userAdd');" class="list-group-item">
                                    用户添加
                                </a>
                            </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                        <div class="panel-body">
                            <div class="list-group">
                                <a href="javascript:$('#content').load('${pageContext.request.contextPath}/back/order/list.jsp');" class="list-group-item active">
                                    订单列表
                                </a>
                            </div>
                        </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                        <div class="panel-body">
                            <div class="list-group">
                                <a href="javascript:$('#content').load('${pageContext.request.contextPath}/back/system/list.jsp');" class="list-group-item active">
                                    系统列表
                                </a>
                            </div>
                        </div>
